...
#videosearch-ai-panel .vsa-collapse-btn {
  ...
  padding: 0;
  border: none;
  border-radius: 0 var(--vsa-radius) 0 10px;
...
#videosearch-ai-panel .vsa-src-host {
  display: flex;
  flex-direction: column;
  gap: 14px;
...
#videosearch-ai-panel .vsa-src-empty {
  font-size: 12px;
  color: var(--vsa-muted);
  line-height: 1.45;
  padding: 18px 8px;
...
#videosearch-ai-panel .vsa-src-h {
  font-size: 10.5px;
  font-weight: 750;
...
#videosearch-ai-panel .vsa-src-row {
  display: flex;
  align-items: center;
  gap: 8px;
  padding: 8px 10px;
...
#videosearch-ai-panel .vsa-src-kind {
  flex-shrink: 0;
  font-size: 9.5px;
  font-weight: 750;
  letter-spacing: 0.04em;
...
#videosearch-ai-panel .vsa-src-label {
  min-width: 0;
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
